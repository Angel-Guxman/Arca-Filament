...
<body class=" bg-black">
    <style>
        ...
        height: 5px; /* Alto de la barra de desplazamiento (para el desplazamiento horizontal) */
        }

        /* Estilo del "track" (fondo) de la barra de desplazamiento */
        body::-webkit-scrollbar-track {
         background: transparent; /* Color de fondo de la pista */ 
        border-radius: 10px; /* Radio de esquina del track */
        
        }
        ::-webkit-scrollbar-thumb {
        background: #888; /* Color del thumb */
        border-radius: 10px; /* Radio de esquina del thumb */
        }
    </style>
    ...
    <footer class=" bg-[#191919]  p-4 mt-2  text-white">
        <div class=" grid grid-cols-3">
            <div class=" flex flex-col items-center gap-4 ">
                <a href="" class=" hover:scale-105 duration-200 hover:underline-offset-4 hover:underline">Avisos de Privacidad</a>
                <a href=""class=" hover:scale-105 duration-200 hover:underline-offset-4 hover:underline">Cuidados</a>
                <a href="" class=" hover:scale-105 duration-200 hover:underline-offset-4 hover:underline">Historia</a>
            </div>
            <div class=" flex flex-col items-center gap-4">
                <a href="" class=" hover:scale-105 duration-200 hover:underline-offset-4 hover:underline">Misión</a>
                <a href="" class=" hover:scale-105 duration-200 hover:underline-offset-4 hover:underline">Visión</a>
                <a href="" class=" hover:scale-105 duration-200 hover:underline-offset-4 hover:underline">Contacto</a>
            </div>
            <div class=" flex flex-col items-center gap-4">
                ...
                <div class=" flex gap-3 ">
                    <a href="" class=" hover:scale-105 duration-200">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"  class="  h-6 w-6" viewBox="0,0,256,256">
                            <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><g transform="scale(5.33333,5.33333)"><path d="M16.5,5c-6.33361,0 -11.5,5.16639 -11.5,11.5v15c0,6.33276 5.16621,11.5 11.5,11.5h15c6.33294,0 11.5,-5.16706 11.5,-11.5v-15c0,-6.33379 -5.16724,-11.5 -11.5,-11.5zM16.5,8h15c4.71124,0 8.5,3.78779 8.5,8.5v15c0,4.71106 -3.78894,8.5 -8.5,8.5h-15c-4.71221,0 -8.5,-3.78876 -8.5,-8.5v-15c0,-4.71239 3.78761,-8.5 8.5,-8.5zM34,12c-1.105,0 -2,0.895 -2,2c0,1.105 0.895,2 2,2c1.105,0 2,-0.895 2,-2c0,-1.105 -0.895,-2 -2,-2zM24,14c-5.50482,0 -10,4.49518 -10,10c0,5.50482 4.49518,10 10,10c5.50482,0 10,-4.49518 10,-10c0,-5.50482 -4.49518,-10 -10,-10zM24,17c3.88318,0 7,3.11682 7,7c0,3.88318 -3.11682,7 -7,7c-3.88318,0 -7,-3.11682 -7,-7c0,-3.88318 3.11682,-7 7,-7z"></path></g></g>
                        </svg>
                    </a>
                    <a href="" class=" hover:scale-105 duration-200">
                    ...
                    <a href="" class=" hover:scale-105 duration-200 ">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class=" h-6 w-6" viewBox="0,0,256,256">
                            <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><g transform="scale(5.12,5.12)"><path d="M25,2c-12.65234,0 -23,9.59766 -23,21.5c0,6.50781 3.13281,12.28516 8,16.21875v8.9375l1.46875,-0.78125l7.21875,-3.75c2.01563,0.53906 4.11328,0.875 6.3125,0.875c12.65234,0 23,-9.59766 23,-21.5c0,-11.90234 -10.34766,-21.5 -23,-21.5zM25,4c11.64453,0 21,8.75781 21,19.5c0,10.74219 -9.35547,19.5 -21,19.5c-2.16406,0 -4.25781,-0.3125 -6.21875,-0.875l-0.375,-0.09375l-0.34375,0.1875l-6.0625,3.15625v-6.5625l-0.375,-0.28125c-4.66406,-3.58984 -7.625,-8.99219 -7.625,-15.03125c0,-10.74219 9.35547,-19.5 21,-19.5zM22.71875,17.71875l-12.03125,12.75l10.8125,-6.0625l5.78125,6.1875l11.875,-12.875l-10.53125,5.90625z"></path></g></g>
                        </svg>
                    </a>
