...
.product-price-card {
    ...
    <section class=" grid grid-cols-1 md:grid-cols-2 gap-3  p-4 mb-5  mt-14">
        <div class=" text-white underline-offset-2 underline animation-description  flex flex-col text-center items-center  justify-center gap-2 mb-3 ">
        ...
        <div  class=" max-h-[400px]  max-w-[400px] mx-auto ">
            <img class=" image-reveal h-full w-full object-contain" src="{{asset('images/alessandro-2.png')}}" alt="">
        </div>
        ...
        <div class=" md:px-[15px] px-2  cont-viewport-products-customer">
           ...
           <div class=" cont-carrusel-product">
            ...
            <a class=" relative group card-carrusel-product shadow-md  bg-black  " href=''>
                    ...
                    <img src="{{asset('images/Pulsera.png')}}" alt="" class="   img-products-customer group-hover:opacity-70 duration-200 object-contain">
            
         <h1 class=" absolute opacity-0 z-10 top-1/4 text-center  text-2xl font-medium left-0 right-0 group-hover:opacity-100  text-white   ">
          Pulsera de Jade Azul
         </h1>
     <p class=" z-10 absolute opacity-0 top-2/4   group-hover:opacity-100 text-center text-white    p-[2px] text-pretty ">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta, cum aliquam facilis officia dicta error, quia voluptatibus iste aperiam laudantium tempora impedit adipisci esse beatae repudiandae reiciendis commodi minima dolorem!
    </p>
        ...
        <div class="md:px-[15px] px-2  cont-viewport-products-customer">
           ...
           <div class=" cont-carrusel-product">
            ...
            <a class=" relative group card-carrusel-product shadow-md  bg-black  " href=''>
                    ...
                    <img src="{{asset('images/Collares.png')}}" alt="" class="   img-products-customer group-hover:opacity-70 duration-200 object-contain">
            
         <h1 class=" absolute opacity-0 z-10 top-1/4 text-center  text-2xl font-medium left-0 right-0 group-hover:opacity-100  text-white   ">
          Pulsera de Jade Rosa
         </h1>
     <p class=" z-10 absolute opacity-0 top-2/4 text-xl font-medium   group-hover:opacity-100 text-center text-white    p-[2px] text-pretty ">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta, cum aliquam facilis officia dicta error, quia voluptatibus iste aperiam laudantium tempora impedit adipisci esse beatae repudiandae reiciendis commodi minima dolorem!
    </p>
        ...
        <div class="md:px-[15px] px-2  cont-viewport-products-customer">
           ...
           <div class=" cont-carrusel-product">
            ...
            <a class=" relative group card-carrusel-product shadow-md  bg-black  " href=''>
                    ...
                    <img src="{{asset('images/Aretes.png')}}" alt="" class="   img-products-customer group-hover:opacity-70 duration-200 object-contain">
