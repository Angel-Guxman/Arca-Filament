...
@keyframes rota{
    ...
    <section class=" grid md:grid-cols-1  gap-5   p-4 mb-14  mt-14">
        <div class=" text-white underline-offset-2 underline animation-description  flex flex-col text-center items-center  justify-center gap-2 mb-5 ">
        ...
        <div  class=" mx-auto md:w-[600px] w-[300px] duration-200  animation-description     ">
            <div class=" md:w-[600px] w-[300px] h-[300px] relative  p-2 group  ">
                <img src="{{asset('images/vendor/img-tres.jpg')}}" class="  group-hover:brightness-75 rounded-md  h-full w-full" alt="">
                <span class=" absolute z-10  top-1/2 text-center group-hover:opacity-100 opacity-0 duration-200  text-lg font-medium text-white  left-0 right-0 ">Lorem ipsum dolor, sit amet consectetur adipisicing elit</span>
            </div>
            <div class=" grid grid-cols-2  md:h-[400px] ">
                <div class=" w-full p-2 md:h-[400px] relative group  ">

                    <img src="{{asset('images/vendor/img-uno.jpg')}}" class="  group-hover:brightness-75 rounded-md image-reveal h-full w-full " alt="">
                <span class=" absolute z-10 top-1/2 right-0 left-0 text-center group-hover:opacity-100 duration-200 opacity-0 md:text-lg text-xs md:font-medium text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit</span>

                </div>
                <div class=" p-2 md:h-[400px] w-full relative group  ">

                    <img src="{{asset('images/vendor/img-dos.jpg')}}" class=" group-hover:brightness-75  rounded-md image-reveal h-full w-full " alt="">
                <span class=" absolute z-10 top-1/2 text-center   right-0 left-0 group-hover:opacity-100 duration-200 opacity-0 md:text-lg text-xs  md:font-medium text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit</span>
    ...
    <section class=" animation-description   relative mb-28 mt-14">
        ...
        <div class="  flex justify-center py-4 ">
            <a   href="" class=" text-lg text-white  mx-auto py-1 hover:text-emerald-100 duration-200   underline underline-offset-4   ">Ver Más</a>
    ...
    <section class=" animation-description  relative mb-28 mt-14">
        ...
        <div class="  flex justify-center py-4 ">
            <a   href="" class=" text-lg text-white  mx-auto py-1   underline underline-offset-4 hover:text-emerald-100 duration-200 ">Ver Más</a>
